module.exports = {
    en: {
        translation: {
            ...
            DAYS_LEFT_MSG: `{{name}} There's {{count}} day left until your anniversary.`,
            DAYS_LEFT_MSG_plural: '{{name}} There are {{count}} days left until your anniversary. ',
            ...
            FUN_FACT_MSG_lst:[`her favorite food are quesadillas. `, `Your favorite activity to do together is to go to concerts. `, `his favorite color is blue. `, `fun fact 4`, `you met 3 years ago during the cervantine festival. `],
